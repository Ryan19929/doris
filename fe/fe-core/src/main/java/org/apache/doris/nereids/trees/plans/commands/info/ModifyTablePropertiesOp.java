 ...
 */
public class ModifyTablePropertiesOp extends AlterTableOp {
    ...
    public void validate(ConnectContext ctx) throws UserException {
        ...
        if (properties.containsKey(PropertyAnalyzer.PROPERTIES_COLOCATE_WITH)) {
            ...
            if (!properties.get(PropertyAnalyzer.PROPERTIES_ENABLE_MOW_LIGHT_DELETE)
                    ...
                    && !properties.get(PropertyAnalyzer.PROPERTIES_ENABLE_MOW_LIGHT_DELETE).equalsIgnoreCase("false")) {
                throw new AnalysisException(
                        "Property "
            ...
            if (!properties.get(PropertyAnalyzer.PROPERTIES_DISABLE_AUTO_COMPACTION).equalsIgnoreCase("true")
                    && !properties.get(PropertyAnalyzer.PROPERTIES_DISABLE_AUTO_COMPACTION).equalsIgnoreCase("false")) {
                throw new AnalysisException(
                        "Property "
