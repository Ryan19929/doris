...
public class PinyinTokenizerValidator extends BasePolicyValidator {
    ...
    protected void validateSpecific(Map<String, String> props) throws DdlException {
        ...
        validateBooleanParameter(props, "remove_duplicate_term");
        ...
        // 验证 limit_first_letter_length 参数
    ...
    private void validateConfigurationLogic(Map<String, String> props) throws DdlException {
        ...
        // 验证 keep_separate_first_letter 和 keep_first_letter 的关系
        ...
        // 验证 keep_none_chinese_in_first_letter 和 keep_first_letter 的关系
        ...
        // 验证 keep_none_chinese_in_joined_full_pinyin 和 keep_joined_full_pinyin 的关系
        boolean keepNoneChineseInJoinedFullPinyin = getBooleanValue(props, "keep_none_chinese_in_joined_full_pinyin", false);
        if (keepNoneChineseInJoinedFullPinyin && !keepJoinedFullPinyin) {
            throw new DdlException("keep_none_chinese_in_joined_full_pinyin requires keep_joined_full_pinyin to be enabled");
        }

        // 验证 limit_first_letter_length 和 keep_first_letter 的关系
