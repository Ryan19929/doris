...
public class RestoreJob extends AbstractJob implements GsonPostProcessable {
    ...
    private static final String PROP_STORAGE_MEDIUM = RestoreStmt.PROP_STORAGE_MEDIUM;
    private static final String PROP_MEDIUM_ALLOCATION_MODE = RestoreStmt.PROP_MEDIUM_ALLOCATION_MODE;
    ...
    private String storageMedium = RestoreStmt.STORAGE_MEDIUM_SAME_WITH_UPSTREAM;
    // Medium allocation mode: "strict" or "adaptive"
    @SerializedName(value = "mediumAllocationMode")
    private String mediumAllocationMode = RestoreStmt.MEDIUM_ALLOCATION_MODE_STRICT;
    ...
    public RestoreJob(String label, String backupTs, long dbId, String dbName, BackupJobInfo jobInfo, boolean allowLoad,
        ...
        this.storageMedium = (storageMedium == null || storageMedium.trim().isEmpty())
                ? RestoreStmt.STORAGE_MEDIUM_SAME_WITH_UPSTREAM : storageMedium;
        this.mediumAllocationMode = (mediumAllocationMode == null || mediumAllocationMode.trim().isEmpty())
                ? RestoreStmt.MEDIUM_ALLOCATION_MODE_STRICT : mediumAllocationMode;
    ...
    public RestoreJob(String label, String backupTs, long dbId, String dbName, BackupJobInfo jobInfo, boolean allowLoad,
        ...
        this(label, backupTs, dbId, dbName, jobInfo, allowLoad, replicaAlloc, timeoutMs, metaVersion, reserveReplica,
                reserveDynamicPartitionEnable, isBeingSynced, isCleanTables, isCleanPartitions,
                isAtomicRestore, isForceReplace, storageMedium, mediumAllocationMode, env, repoId);
    ...
    public boolean isSameWithUpstream() {
        return RestoreStmt.STORAGE_MEDIUM_SAME_WITH_UPSTREAM.equals(storageMedium);
    }

    // Get target allocation mode as enum
    private DataProperty.MediumAllocationMode getTargetAllocationMode() {
        if (RestoreStmt.MEDIUM_ALLOCATION_MODE_STRICT.equals(mediumAllocationMode)) {
            return DataProperty.MediumAllocationMode.STRICT;
        } else if (RestoreStmt.MEDIUM_ALLOCATION_MODE_ADAPTIVE.equals(mediumAllocationMode)) {
    ...
    public void gsonPostProcess() throws IOException {
        ...
        storageMedium = properties.getOrDefault(PROP_STORAGE_MEDIUM,
                RestoreStmt.STORAGE_MEDIUM_SAME_WITH_UPSTREAM);
        mediumAllocationMode = properties.getOrDefault(PROP_MEDIUM_ALLOCATION_MODE,
                RestoreStmt.MEDIUM_ALLOCATION_MODE_STRICT);
    }
