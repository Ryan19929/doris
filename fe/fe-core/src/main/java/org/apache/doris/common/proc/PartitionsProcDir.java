    ...
    private List<Pair<List<Comparable>, TRow>> getPartitionInfosInrernal() throws AnalysisException {
        ...
        try {
            ...
            for (Long partitionId : partitionIds) {
                ...
                String mediumAllocationModeValue = dataProperty.getMediumAllocationMode().getValue();
                partitionInfo.add(mediumAllocationModeValue);
                trow.addToColumnValue(new TCell().setStringVal(mediumAllocationModeValue));
