...
// with a valid range of [200, 500], and the interval defaults to 1000 ms with a valid range of
// [0, 1000]. These bounds prevent dynamic throttling from being slower than the historical pace.
// Values outside these ranges fall back to the historical defaults at the use site.
