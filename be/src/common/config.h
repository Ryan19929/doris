...
// BE-only dynamic config. Default is 200 and the valid range is [200, 500]. Values outside the
// valid range fall back to the historical limit of 200 at the use site.
DECLARE_mInt32(shutdown_tablet_sweep_round_budget);
// BE-only dynamic config. Default is 1000 ms and the valid range is [0, 1000]. A value of 0
